<?php
$page_title = "About - Philanthropy Circuit";
  $page_name = "about";
...
$row = $stmt->fetch(PDO::FETCH_BOTH);
  ...
  <p style="text-align: justify;">To stay updated on our progress and to receive our most important content, subscribe to our newsletter, <strong>The Weekly Circuit.</strong>  For other enquiries, please send an email to: editor@philanthropycircuit.com.</p> -->
  </div>		</div>
            </div>
          </div>
