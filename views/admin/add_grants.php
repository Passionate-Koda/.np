...
<h2 class="title-2">Welcome to the Grant page</h2>
<div class="row search-bar mb30 red-bg">
<div class="advanced-search">
<form class="search-form" method="get">
<div class="col-md-4 col-sm-12 search-col">
<h3>Please post your Grant.</h3>
</div>
</form>
</div>
</div>
...
<label class="control-label">Grant Title</label><?php $display = displayErrors($error, 'title');
echo $display ?> <input class="form-control input-md" name="title" placeholder="Write a suitable title for Grant"  type="text">
</div>
<div class="form-group mb30">
<label class="control-label">Link</label><?php $display = displayErrors($error, 'link');
echo $display ?> <input class="form-control input-md" name="link" placeholder="Grant Link"  type="text">

<div class="form-group mb30">
<label class="control-label" for="textarea">Body</label>
<?php $display = displayErrors($error, 'body');
echo $display ?>
<textarea class="form-control"  id="editor" name="body" placeholder="Write your Grant Details here" rows="4"></textarea>
</div>
